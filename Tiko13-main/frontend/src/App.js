...
function StudioIll() {
  ...
  const handleFileChange = async (event) => {
    ...
    formData.append('illustration_image_0', selectedFile); // Добавляем файл с нужным ключом

  // Если есть описание, добавьте его
  // formData.append('illustration_description_0', 'Описание иллюстрации');
    ...
    // Обновите состояние или выполните другие действия после успешной загрузки
    } catch (error) {
